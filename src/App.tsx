    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 font-sans antialiased selection:bg-amber-500 selection:text-slate-950 flex flex-col">
      ...
      >
        ...
        {!(activeTab === 'match' && matchesSubTab === 'center') && (
          <div className="bg-slate-900/95 border-b border-amber-500/30 px-2.5 sm:px-6 py-1.5 sm:py-2 flex items-center justify-between gap-2 sm:gap-3 shadow-md sticky top-[57px] z-20 backdrop-blur-md">
            <div className="flex items-center gap-2.5 sm:gap-3 min-w-0">
              <div className="hidden sm:block w-2.5 h-2.5 rounded-full bg-amber-400 animate-pulse shrink-0" />
              <div className="flex items-center gap-1 sm:gap-2 text-[11px] sm:text-sm font-black text-white min-w-0">
            ...
            <div className="flex items-center gap-2 shrink-0">
              <button
                ...
                className="bg-slate-800 hover:bg-slate-700 text-amber-400 hover:text-white font-black text-xs p-2 sm:px-3 sm:py-1.5 rounded-xl border border-amber-500/30 flex items-center gap-1.5 transition cursor-pointer shadow-sm"
                title="Volver a la pantalla principal del Centro del Partido"
              >
                <ArrowLeft className="w-3.5 h-3.5" />
                <span className="hidden sm:inline">← Centro del Partido</span>
              </button>
